...
public class D_2_Static_methods2 {
	...
	public void D_write()
	{
		...
		F_findOut(); 
		//Accessing this method directly without creating an object, This means, EITHER:
		//This method HAS to be in this class & it HAS to be labeled as 'static'. 
		
		//OR: This method exists in the parent class that we're extending (inheriting from)
		//  where this child class utilizes the testNG annotation (@Test) [that, behind the scenes,
		// automatically does the job of creating an object of this child class] instead of the plain by default
		// Java complier (that is public static void main(String[] args)

		//Also, accessing method 'F_findOut' via object will still work (Buy why bother if 'static' is used). 
		// And From outside of this class, it can ONLY be accessed via object creation or via: ClassName.StaticMethod().
