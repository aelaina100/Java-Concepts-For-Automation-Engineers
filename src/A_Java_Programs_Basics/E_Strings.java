...
public void StringSplitting_A()
{
	...
	// OR: in case you'd like to save the first element in the array
	...
	{
		sent_reverse= sent_reverse + sent.charAt(i-1); // as soon as you apply the .charAt method, the String it acts upon will 
		                                                 // be types with indexes.
...
public void StringContains()
{
	...
	// does the variable 'course' contain the variable named 'check' ?
	String check= "Java";  // try "Java" and "J". 
	// Note: for a character there is no need to change type to char (From String). Only single quotes are needed
	Assert.assertTrue(course.contains(String.valueOf(check)), "The provided String does not contain: " + check); 
	//msg only displayed when assertion fails.
	System.out.println("PASS: The phrase contains: " + check);
}
